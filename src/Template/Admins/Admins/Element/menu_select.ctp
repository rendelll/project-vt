...
//echo '<button id="btn_closes" onclick="menu_list()" class="btn btn-danger inv-close" style="width: 90px; margin: 14px 6px 0px; font-size: 11px;float:right;">Back</button>';
	...
	if(in_array('Dashboard',$menu_list) && in_array('Home',$menu_list) && in_array('User Management',$menu_list) && in_array('Add User',$menu_list) && in_array('Manage User',$menu_list) && in_array('Manage Moderator',$menu_list) && in_array('Payment Gateway',$menu_list) && in_array('Orders',$menu_list) && in_array('Commission Setup',$menu_list) && in_array('Invoices',$menu_list) && in_array('Tax Rates',$menu_list) && in_array('Add Coupon',$menu_list) && in_array('Manage Coupon',$menu_list) && in_array('Logs Coupon',$menu_list) && in_array('Add Gift Card',$menu_list) && in_array('Logs',$menu_list) && in_array('Manage Category',$menu_list) && in_array('Manage Items',$menu_list) && in_array('Manage Shared Items',$menu_list) && in_array('Manage Prices',$menu_list) && in_array('Manage Colors',$menu_list) && in_array('Manage Currency',$menu_list) && in_array('Manage Sellers',$menu_list) && in_array('Manage Group Gifts',$menu_list) && in_array('User Options',$menu_list) && in_array('Manage Dispute',$menu_list) && in_array('Manage Seller Chat',$menu_list) && in_array('Manage Subjects',$menu_list) && in_array('Site Management',$menu_list) && in_array('Media Management',$menu_list) && in_array('Email Management',$menu_list) && in_array('Manage Landing Page',$menu_list) && in_array('Mobile Apps Settings',$menu_list) && in_array('Social Settings',$menu_list) && in_array('Add Contacts',$menu_list) && in_array('Send Newsletter',$menu_list) && in_array('Get Contacts List',$menu_list) && in_array('Manage Newsletter',$menu_list) && in_array('Manage Modules',$menu_list) && in_array('Google Analytics',$menu_list) && in_array('Manage Banner',$menu_list) && in_array('404 page',$menu_list) && in_array('Faq',$menu_list) && in_array('Contact',$menu_list) && in_array('Terms of Sale',$menu_list) && in_array('Terms of Service',$menu_list) && in_array('Privacy Policy',$menu_list) && in_array('Terms and Conditions',$menu_list) && in_array('Copyright Policy',$menu_list))
		...
		echo '<br />';
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="user">User Management</h3>';
		...
		echo '<br />';		
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="pay">Payment</h3>';
		...
		echo '<br />';		
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="coupon">Coupons</h3>';
		...
		echo '<br />';
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="gift">Gift Card</h3>';
		...
		echo '<br />';
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="store">Store Preferences</h3>';
		...
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="disp">Disputes</h3>';
	...
	echo '<div style="width:49% !important;float:right;">';
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="msg">Messages</h3>';
		...
		echo '<br />';
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="site">Site Management</h3>';
		if(in_array('Site Management',$menu_list))
		echo '<input type="checkbox" checked="checked" value="Site Management" name="chkbox" class="sitechk">Site Management';
		else
		...
		echo '<br />';	
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="news">Newsletter</h3>';
		...
		echo '<br />';		
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="gen">General Settings</h3>';
		...
		echo '<br />';
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="ban">Banner Settings</h3>';
		...
		echo '<br />';
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="error">Error Pages</h3>';
		...
		echo '<br />';
		echo '<h3><input type="checkbox" onclick="check_all(this)" class="help">Help Pages</h3>';
	...
	echo '<div style="width:30%;float:right;margin-top:70px;position:relative;left:50px;">';
		echo '<input type="button" value="Save" onclick="menu_list()" class="btn btn-info">';
		echo '<input type="button" value="Cancel" onclick="close_button()" class="btn btn-danger">';
	echo '</div>';
?>
