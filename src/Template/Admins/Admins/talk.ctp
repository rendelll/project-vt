...
<div class="content">
 	<div class="row page-titles">
        <div class="col-md-12 col-12 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0"> <?php echo $setngs[0]['site_name']; ?> <?php echo __d('admin', 'Talk'); ?></h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo $baseurl; ?>dashboard"><?php echo __d('admin', 'Home'); ?></a></li>
                     <li class="breadcrumb-item"><a href="#"> <?php echo $setngs[0]['site_name']; ?><?php echo __d('admin', 'Talk'); ?></a></li>
...
<div class="col-lg-12 p-0">
            <div class="card card-outline-info">
                <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo $setngs[0]['site_name']; ?> <?php echo __d('admin', 'Talk'); ?></h4>
                 </div>
