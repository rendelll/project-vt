<div class="row page-titles m-b-20">
  <div class="col-md-12 col-lg-12 align-self-center">
      <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'Send Newsletter'); ?></h3>
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo __d('admin', 'Send Newsletter'); ?></li>
      </ol>
  </div>
</div>
    ...
    <div class="col-12">
        <div class="card">
                <div class="card-block">
                    <h4 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'Newsletter'); ?></h4>
                    <hr>
                    <div class="col-md-6 col-sm-12 ">

                        <?php echo $this->Form->Create('newsletter',array('url'=>array('controller' => '/admins','action' => '/newsletter'),'name'=>'newsletter','id'=>'newsletter' , 'onsubmit'=> 'return sendnewsletter()'));
                        ?>

                            <input type="hidden" id="nkey" value="<?php echo $settings_datas['news_key']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-control-feedback f4-error f4-error-subject"></small> 
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-control-feedback f4-error f4-error-message"></small> 
                            </div>
