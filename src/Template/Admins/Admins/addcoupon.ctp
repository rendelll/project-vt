            ...
            <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'Coupons'); ?></h3>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo $baseurl; ?>	admin/managecoupon"><?php echo __d('admin', 'Coupons'); ?></a></li>
                     <li class="breadcrumb-item active"><?php echo __d('admin', 'Add Coupon'); ?></li>
                 </ol>
         </div>
    </div>
</div>
<body class=""> 
  <!--<![endif]-->
	...
	<div class="row">
         <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo __d('admin', 'Add Coupon'); ?></h4>
                 </div>
		...
		<?php
		echo $this->Form->Create('Coupon',array( 'onsubmit' => 'return couponform();'),array('url'=>array('controller'=>'/','action'=>'/admins/addcoupon'),'id'=>'couponform'));?>

		 <div class="row">
         <div class="col-md-6">
         <div class="form-group">
         <label class="control-label" id="coupon_code" name="coupon_code"><?php echo __d('admin', 'Coupon Code'); ?></label>
        <input type="text" id="couponcodes" class="form-control" name="couponcode" value="" maxlength=20>
         </div></div></div>
         <input type="button" class="btn btn-info" value="<?php echo __d('admin', 'Generate coupons'); ?>" id="generate_coupon" onclick="generatecoupon()">

          <div class="row">
         <div class="col-md-6">
         <div class="form-group">
         <label class="control-label" id="range" name="range"><?php echo __d('admin', 'Coupon Usage'); ?></label>
        <input type="text" id="couponrange" class="form-control" name="couponrange" value="" maxlength=20>
         </div></div></div>
          <div class="row">
         <div class="col-md-6">
         <div class="form-group">
         <label class="control-label" id="startdate" name="startdate"><?php echo __d('admin', 'Start date'); ?></label>
        <input type="text" id="deal-start" class="form-control mydatepicker" name="fromdate" value="" maxlength=20 placeholder="<?php echo __d('admin', 'mm/dd/yyyy'); ?>">
         </div></div></div>
          <div class="row">
         <div class="col-md-6">
         <div class="form-group">
         <label class="control-label" id="enddate" name="startdate"><?php echo __d('admin', 'Expire date'); ?></label>
        <input type="text" id="deal-end" class="form-control mydatepicker" name="enddate" value="" maxlength=20 placeholder="<?php echo __d('admin', 'mm/dd/yyyy'); ?>">
         </div></div></div>
		...
		<?php
			...
			//echo $this->Form->input('amount',array('type'=>'text','maxlength'=>'20','label'=>__d('admin', 'Discount amount:'),'class'=>'inputform'));
			echo '<label>'.__d('admin', 'Discount percentage(%):').' <span class="currency_symbol"></span></label>';
			echo "<input type='text' maxlength='3' name='amount' id='amountss' value='' class='form-control'>";
			...
			<?php
			echo '<input type="checkbox" name="onetimeuse">'.__d('admin', 'Restrict to one time use for one user').'';
			echo '<br />';
			echo $this->Form->submit(__d('admin', 'Add Coupon'),array('div'=>false,'class'=>'btn btn-info reg_btn'));
