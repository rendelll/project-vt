...
?>
 ...
 <div class="page page-titles p-b-0">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><?php echo __d('admin', 'Add Price'); ?></li>
                                    </ol>
                                </div>
         ...
         <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo __d('admin', 'Add Price'); ?></h4>
                 </div>
			...
			echo $this->Form->input('from',array('type'=>'text','label'=>__d('admin', 'Price Range From'),'id'=>'inputform1','class'=>'form-control'));
			echo '</div></div> 	<br>
			 <div class="row">
                        <div class="col-md-6">';
			echo $this->Form->input('to',array('type'=>'text','label'=>__d('admin', 'Price Range To'),'id'=>'inputform2','class'=>'form-control'));
			echo '</div></div>';
			echo '<br>';
