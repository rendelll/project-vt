...
echo  '<div class="table-responsive m-t-40">';
				...
				echo "<tr >";
					...
					echo '<th>'.__d('admin', 'Select').'</th>';
					echo "<th>".__d("admin", "Id")."</th>";					
					echo "<th>".__d("admin", "Item title")."</th>";
          ...
          echo "<th>".__d("admin", "Size Options")."</th>";
          echo "<th>".__d("admin", "Created")."</th>";
          //echo "<th>".__d("admin", "Mark Featured")."</th>";
             ...
             /* if ($temp['featured'] == 0){
              ...
              echo "<td class='aligncenter'> <span id='status".$item_id."'>";
                echo "<button class='btn ".$color."' style='font-size:11px;width:60px;' onclick='changeItemStatus(".$item_id.",\"".$temp['status']."\");'>".$buttonLabel."</button>";
                 ...
                 //  <a href="'.SITE_URL.'admin/edititem/'.$item_id.'" style="cursor:pointer;"><span class="btn btn-info"><i class="mdi mdi-border-color"></i></span></a>
              echo "</span></td>";
