<?php
echo '<table id="listcontacts" border="2" class="m-t-30" style="width:100%;"><tr><th class="text-center">'.__d('admin', 'Username').'</th><th class="text-center">'.__d('admin', 'Email').'</th><!--th class="text-center">Action</th --></tr>';
if(count($result)>0)
{
...
{
	echo '<tr><td colspan="3" align="center">'.__d('admin', 'No Contacts Found').'</td></tr>';
}
echo '</table>';
