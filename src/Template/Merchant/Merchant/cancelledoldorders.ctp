...
<div class="row page-titles m-b-20">
  <div class="col-md-6 col-lg-12 align-self-center">
      <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('merchant','Cancelled Orders'); ?></h3>
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo MERCHANT_URL;?>/cancelledorders"><?php echo __d('merchant','Cancelled Orders'); ?></a></li>
			...
			<div class="card-block">
     			<h4 class="text-themecolor m-b-0 m-t-0 clearfix"> <?php echo __d('merchant','Old Orders'); ?>
	     			<ul class="nav nav-pills" style="display: inline-flex; float: right;">
	        			<li class=" nav-item"> 
	        				<a href="<?php echo MERCHANT_URL; ?>/cancelledorders" class="nav-link"><?php echo __d('merchant','View recent orders');?> </a> 
	        			</li>
	    			</ul>
	 			</h4>
	 	    	<hr/>
         		...
         		<div class="prvcmntcont m-t-30">
					...
					if (count($orderDetails) > 0) {  
         			  echo '<span class="col-sm-3 p-l-0"> '.__d('merchant','Filters').' <!-- input type="text" id="ordersearchval" style="margin-top:7px;"  --> </span>
						...
						<!-- button class="btn btn-success" onclick="cancelledoldorder_search()" style="vertical-align:inherit;">Search</button>
						<a class="btn btn-info clearResult" href="'.MERCHANT_URL.'/cancelledoldorders" style="vertical-align:inherit;">Reset</a -->';
					?> 
        	...
        	<table id="myTable" class="table table-bordered table-striped">
				...
				foreach($orderDetails as $ky=>$orderDetail){
					...
					<tr>
						...
						<td class="status<?php echo $orderid; ?>" style="width: 70px;color:<?php echo $statusColor; ?>;"><?php if(strtolower($orderStatusCurrent) == "refunded") { echo __d('merchant','Cancelled'); } else { echo __d('merchant',$orderStatusCurrent); }
							?></td>
