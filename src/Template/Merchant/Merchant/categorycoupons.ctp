<div class="row page-titles m-b-20">
  <div class="col-md-6 col-lg-12 align-self-center">
      <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('merchant','Category Coupons'); ?></h3>
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo __d('merchant','Category Coupons'); ?></li>
      </ol>
  </div>
</div>
            ...
            <div class="card-block">
                ...
                <h4 class="text-themecolor m-b-0 m-t-0 clearfix"><span class="rightTitle"><?php echo __d('merchant','Manage Coupons'); ?></span>
                 <ul id = "nav-altertable" class="nav nav-pills" style="display: inline-flex; float: right;">
                    ...
                    <li class="nav-item"> <a href="<?php echo MERCHANT_URL; ?>/itemcoupons" class="nav-link"><?php echo __d('merchant','Item Coupons'); ?></a> </li>
                    <li class="nav-item"> <a href="<?php echo MERCHANT_URL; ?>/categorycoupons" class="nav-link active"><?php echo __d('merchant','Category Coupons'); ?></a> </li>
                </ul></h4>
                <hr/>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="producttd"><?php echo __d('merchant','Category');?></th>
                        ...
                        <?php
                            ...
                            foreach($getcouponval as $key=>$user_det)
                            {
                                ...
                                echo '</td><td class="producttd">';
                                echo $user_det['category']['category_name'];
                                echo '</td><td>';
                                ...
                                echo "<a data-ajax='false'  href=".MERCHANT_URL."/editcategorycoupon/".$id."><span class='btn btn-info'><i class='fa fa-edit'></i></span></a>
