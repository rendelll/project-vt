<div class="row page-titles m-b-20">
  <div class="col-md-6 col-lg-12 align-self-center">
      <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('merchant','Cart Coupons'); ?></h3>
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo __d('merchant','Cart Coupons'); ?></li>
      </ol>
  </div>
</div>
            ...
            <div class="card-block">
                ...
                <h4 class="text-themecolor m-b-0 m-t-0 clearfix"><span class="rightTitle"><?php echo __d('merchant','Manage Coupons'); ?></span>
                 <ul id = "nav-altertable" class="nav nav-pills" style="display: inline-flex; float: right;">
                    <li class=" nav-item"> <a href="<?php echo MERCHANT_URL; ?>/cartcoupons" class="nav-link active"><?php echo __d('merchant','Cart Coupons'); ?></a> </li>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <?php
                            ...
                            foreach($getcouponval as $key=>$user_det)
                            {
                                ...
                                echo "<a data-ajax='false'  href=".MERCHANT_URL."/addcartcoupon/".$id."><span class='btn btn-info'><i class='fa fa-edit'></i></span></a>
