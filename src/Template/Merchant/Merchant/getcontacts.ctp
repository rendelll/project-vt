<div class="row page-titles m-b-20">
  <div class="col-md-6 col-lg-12 align-self-center">
      <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('merchant','Contacts List'); ?></h3>
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo __d('merchant','Get Contacts List'); ?></li>
      </ol>
  </div>
</div>
    ...
    <div class="col-12">
        <div class="card">
                <div class="card-block">
                    <h4 class="text-themecolor m-b-0 m-t-0"><?php echo __d('merchant','Contacts List'); ?></h4>
                    <hr>
                    <div class="col-md-6 col-sm-12 ">
                            ...
                            <div class="form-group">
                                ...
                                <input id="apikey" type="hidden" value="<?php echo $shop_datas['news_key']; ?>">
                            </div>


                            <div class="button-group">
                                <button class="btn btn-rounded btn-info" onclick="get_contacts_list()" ><i class="fa fa-check"></i>
                                <?php echo __d('merchant','Get Contacts'); ?></button>
                                ...
                                <?php echo __d('merchant','Add New Contacts'); ?></a>
