...
<div class="row page-titles m-b-20">
  <div class="col-md-6 col-lg-12 align-self-center">
      ...
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo __d('merchant','Cancelled Orders'); ?></li>
      </ol>
  </div>
</div>
	...
	<div class="col-md-12">
		...
		<div class="card">  
			<div class="card-block">
     			<h4 class="text-themecolor m-b-0 m-t-0 clearfix"> <?php echo __d('merchant','Cancelled Orders'); ?>
     			<?php
	        	if($oldordercount>0)
	        	{
	        	?>
	     			<ul class="nav nav-pills" style="display: inline-flex; float: right;">
	        			<li class=" nav-item"> 
	        				<a href="<?php echo MERCHANT_URL; ?>/cancelledoldorders" class="nav-link"><?php echo __d('merchant','View Old Orders'); ?></a> 
	        			</li>
	    			</ul>
	    		<?php } ?>
	 			</h4>
        		...
        		<!-- div class="markshiphead m-b-15" style="font-size:12px;">
         		...
         		<div class="prvcmntcont m-t-30"> 
					...
					if (count($orderDetails) > 0) {  
						...
						<!-- button class="btn btn-success" onclick="cancelledorder_search()" style="vertical-align:inherit;">Search</button>
						<a class="btn btn-info clearResult" href="'.MERCHANT_URL.'/cancelled" style="vertical-align:inherit;">Reset</a -->';
					?>
