...
<div class="row page-titles m-b-20">
  <div class="col-md-6 col-lg-12 align-self-center">
      ...
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo __d('merchant','Returned Orders'); ?></li>
      </ol>
  </div>
</div>
	...
	<div class="col-md-12">
		...
		<div class="card">  
			<div class="card-block">
     			<h4 class="text-themecolor m-b-0 m-t-0 clearfix"> <?php echo __d('merchant','Returned Orders'); ?>
     			<?php
	        	if($oldordercount>0)
	        	{
	        	?>
	     			<ul class="nav nav-pills" style="display: inline-flex; float: right;">
	        			<li class=" nav-item"> 
	        				<a href="<?php echo MERCHANT_URL; ?>/returnedoldorders" class="nav-link"><?php echo __d('merchant','View Old Orders'); ?></a> 
	        			</li>
	    			</ul>
	    		<?php } ?>
	 			</h4>
         		...
         		<div class="prvcmntcont m-t-30"> 
					...
					if (count($orderDetails) > 0) {
         			...
         			echo '<span class="col-sm-3 p-l-0"> '.__d('merchant','Filters').' <!-- input type="text" id="ordersearchval" style="margin-top:7px;"  --> </span>
						...
						<!-- button class="btn btn-success" onclick="returnedorder_search()" style="vertical-align:inherit;">Search</button>
						<a class="btn btn-info clearResult" href="'.MERCHANT_URL.'/returned" style="vertical-align:inherit;">Reset</a -->';
					?>
