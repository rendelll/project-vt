...
<?php
				...
				<div class="white_bg scroll_cart">
						  <div class="hide_mobile_cart row hor-padding">
							...
							foreach($opencart as $setcart)
							{
								...
								$braintree_itemprices[$setcart['itemid']]=$setcart['price'];
								if($setcart['cod'] == 'yes') {
									$cod++;
								}
								unset($shpngs);
							  ...
							  <div class="row hor-padding">
								...
								<div class="cart_dis_table">
									...
									<div class="cart_dis_cell">
										...
										<div class=" margin-left20 text-left text_right_rtl"><?php echo __d('user','Seller');?><?php echo ':';?>
							...
							?>
								...
								<div class="text-right col-xs-12 col-sm-4 col-md-4 col-lg-4 no-hor-padding" id="total_section">
										...
										class="subtotal"><?php echo '<div style="direction:LTR">'. $totalShippingPayable;?>
										<!--CONVERT CURRENCY STARTS-->
										<?php
										...
										<span class="subtotal"><?php echo '<div style="direction:LTR">'.round($indv_perc,2);?>
										<!--CONVERT CURRENCY STARTS-->
										<?php
												if(isset($_SESSION['currency_code']))
												{
										...
										<?php echo '<div style="direction:LTR">'.'-'.$coupondiscount;?>
										<!--CONVERT CURRENCY STARTS-->
										<?php
												if(isset($_SESSION['currency_code']))
												{
										...
										<span class="discountotal red-txt">
										<?php echo '<div style="direction:LTR">'.'-'.$giftcardamount;?>
										<!--CONVERT CURRENCY STARTS-->
										<?php
												if(isset($_SESSION['currency_code']))
												{
										...
										<h6 class="font_size13"><?php echo __('Credits'); echo':';?> 
										<span class="red-txt creditstotal">
										<?php echo '<div style="direction:LTR">'.'-'.$creditamt;?>
										<!--CONVERT CURRENCY STARTS-->
										<?php
												if(isset($_SESSION['currency_code']))
												{
									...
									<span class="grandtotal"><div style="direction:LTR">
									<?php
							...
							<?php $totalAmountPay = $totalamounttopay*100;?>
								...
								<?php
								if(isset($getcouponvalue)){
								echo '<input type="hidden" name="couponId" id="couponIdb" value="'.$getcouponvalue['id'].'" />';
								}else{
								echo '<input type="hidden" name="couponId" id="couponIdb" value="" />';
								}
								?>
								<?php
							...
							<div class="ship_cart_address hide_normal margin-bottom15 padding-top10 padding-bottom10">
								...
								<div class="row">
									<div class="col-xs-6 col-xm-6"><h6 class="font_size13">
									<?php echo ucfirst($taxes['taxname']).' ('.$taxes['percentage'].'%) : ';?></h6>
									</div>
									<div class="col-xs-6 col-xm-6 text-right">
									<h6 class="font_size13">
							...
							<?php }?>
								...
								<div class="row border_top_grey padding-top10">
									<div class="col-xs-6 col-xm-6"><h6 class="font_size13 bold-font"><?php echo __('Amount Payable:');?></h6></div>
									<div class="col-xs-6 col-xm-6 text-right">
            ...
            <ul class="resp-tabs-list hor_1 tab_cart_rtl">
                ...
                <?php if($totalAmountPay=='0' || $totalAmountPay<0) { ?>
                 <li class="horziontal_tab tab_li_rtl cart_tabs bold-font"><?php echo __d('user','Place an Order');?></li>
                 <?php }?>
            ...
            <?php if ($totalAmountPay>0){ ?>
                <div class="active_horizontal">
                   <div class="payment_dis_table margin-bottom15">
						...
						<span class="margin-left10 margin-right10 margin_top10_rtl"><?php echo __d('user','By placing the order, I have read and agreed the'); echo $setngs['site_name'];?> <?php echo __d("user","'s");?> <a href="" class="primary-color-txt"><?php echo __d('user','Terms of Use');?></a></span>
						</div>
				   </div>
				...
				<div class="active_horizontal">
				   ...
				   <div class="view-all-btn btn primary-color-bg primary-color-bg">
						<a data-toggle="modal" data-target="#cod-modal"><?php echo __d('user','Place an Order');?> </a>
					</div>
                </div>
                <?php } ?>
            </div>
        ...
        <?php }?>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 mobile_first padding_ship_address">
				...
				<div class="white_bg">
					...
					<?php 
					if($allproductship==0 && $soldout=='0' && $setgiftcard=='0' && $setcreditamount=='0') { $couponstyle="display:block"; } else { $couponstyle="display:none"; } ?>
					  <div class="panel panel-default applycouponcode" style="<?php echo $couponstyle;?>">
						...
						<div class="panel-body padding-top0">
							...
							<input class="form-control font_size13" name="couponcode" id="couponcode" placeholder="<?php echo __d('user','Enter your Coupon Code');?>">
							...
							<div class="panel-body padding-top0">
								<div class="row margin-top10">
									<div class="col-xs-6 col-sm-6 col-lg-6">
									<div class="btn primary-color-bg primary-color-bg">
										<a onclick="removecodoffers();"><?php echo __d('user','Remove the Coupon discount amount');?></a>
									</div>
									</div>
								</div>
							</div>
					  ...
					  ?>
					   <?php if(!isset($getcouponvalue) && $allproductship==0 && $soldout=='0' && $setcreditamount=='0') { $giftcardstyle="display:block"; } else { $giftcardstyle="display:none"; } ?>
						...
						<?php }
							...
							<div class="panel-body padding-top0">
								<div class="row margin-top10">
									<div class="col-xs-6 col-sm-6 col-lg-6">
									<div class="btn primary-color-bg primary-color-bg">
										<a onclick="removecodoffers();"><?php echo __d('user','Remove the Giftcard amount');?></a>
									</div>
									</div>
								</div>
							</div>
					  ...
					  ?>
					   ...
					   <?php if($allproductship==0 && $soldout=='0' && $setcoupon=='0' && $setgiftcard=='0') { $applycreditamount="display:block"; } else { $applycreditamount="display:none"; } ?>
						...
						<?php if($available_bal >0){
							...
							<div class="panel-body padding-top0">
								<div class="row margin-top10">
									<div class="col-xs-6 col-sm-6 col-lg-6">
									<div class="btn primary-color-bg primary-color-bg">
										<a onclick="removecodoffers();"><?php echo __d('user','Remove the Credit Amount');?></a>
									</div>
									</div>
								</div>
							</div>
									...
									<div class="signup-left-cnt col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
											<h2 class="login-header-text bold-font txt-uppercase col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding"><?php echo __d('user','Confirm your order');?></h2>
													...
													<div class="padding-top15 col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding text-right">
														...
														<div id="captcherr" class="errcls"><?php echo __d('user','Captcha is not valid');?></div>
