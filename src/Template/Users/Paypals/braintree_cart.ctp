...
<form name="paymentbraintreeform" method="post" action="<?php echo SITE_URL.'braintree/checkout/'?>">
    <input type="hidden" value="<?php echo $totalprice; ?>" id="totalpriceb" name="totalPrice">
    <input type="hidden" value="<?php echo $totalprice; ?>" id="totalpriceb" name="totalsPrice">
    <input type="hidden" name="userid" id="userid" value="<?php echo $userid; ?>"/>
    <input type="hidden" name="itemids" id="itemids" value="<?php echo $itemids; ?>"/>
    <input type="hidden" name="itmunitPrice" id="itmunitprice" value='<?php echo $itmunitprice; ?>'/>
    <input type="hidden" name="delivertype" id="delivertypeb" value="<?php echo $delivertype; ?>"/>
    <input type="hidden" name="shipamnt" id="shipamntb" value='<?php echo $shipamnt; ?>'/>
    <input type="hidden" name="shippingId" value="<?php echo $shippingId; ?>" id="stripe_shipIdb" />
    <input type="hidden" name="taxamt" id="taxamtb" value="<?php echo $taxamt; ?>"/>
    <input type="hidden" id="couponIdb" name="couponId" value="<?php echo $couponId; ?>"/>
    <input type="hidden" name="giftcardId" value="<?php echo $giftcardId; ?>" id="giftcardIdb" />
    <input type="hidden" name="currentTime" value="<?php echo $currentTime; ?>" id="currentTime" />
    <input type="hidden" name="currency" id="currencode" value="<?php echo $currency; ?>"/>
    <input type="hidden" name="userEnterCreditAmt" value="<?php echo $userEnterCreditAmt;?>" id="userEnterCreditAmt" />
    ...
    <input type="hidden" name="buynow" id="buynow" value="<?php echo $buynow;?>"/>
    <input type="hidden" name="buynow_qty" id="buynow_qty" value="<?php echo $buynow_qty;?>"/>
    <input type="hidden" name="buynow_size" id="buynow_size" value="<?php echo $buynow_size;?>"/>
