	<div class="container margin_top165_mobile">
		...
		<div id="content" class="col-lg-9 col-md-9 col-sm-12 col-xs-12 no-hor-padding clearfix min-height-profile">
						<div class="cnt-top-header border_bottom_grey col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
							<h2 class="user_profile_inner_heading pro-title-head section_heading bold-font extra_text_hide fint-height col-lg-6 col-md-6 col-sm-6 col-xs-12"><?php echo __d('user','Return Order');?> </h2>
						</div>
		<?php
	        	$shipmentDate = '';
	        	$trackid = '';
...
<form>
		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
			<div class="email-addr padding-bottom15 col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding adres-alighn">
				...
				<input type="text" class="popup-input col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding" name="shipmentdate" id="shipmentdate" value="<?php echo date('m/d/Y',$shipmentDate); ?>">
			</div>
			<div class="shipmentdateerror error trn cs-error"></div>
			<div class="email-addr padding-bottom15 col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no-hor-padding">
						<div class="divtwo clearfix">
						  <input type="text" class="popup-input col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding" name="couriername" id="couriername" value="<?php echo $couriername; ?>"  placeholder="<?php echo __d('user','Enter the Courier');?>">
						</div>
					</div>

					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no-hor-padding">
						<div class="divtwo clearfix">
						  <input class="popup-input col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding" type="text" name="courierservice" id="courierservice" value="<?php echo $courierservice; ?>"  placeholder="<?php echo __d('user','Shipping Service');?>">
						</div>
					</div>
			</div>
			<div class="couriernameerror error trn cs-error"></div>
			<div class="email-addr padding-bottom15 col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding adres-alighn">
				...
				<input class="popup-input col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding" type="text" name="trackingid" id="trackingid" value="<?php echo $trackid; ?>">
			</div>
			<div class="trackingiderror error trn cs-error"></div>
			<div class="email-addr padding-bottom15 col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding adres-alighn">
...
<textarea rows="10" cols="15" id="notes" class="popup-input col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding" ><?php echo $notes; ?></textarea>
			</div>
			<div class="email-addr padding-bottom15 col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding adres-alighn">
				<div class="popup-label-text col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding bold-font"><?php echo __d('user','Reason For Return');?></div>
<textarea rows="10" cols="15" id="reason" class="popup-input col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding" ><?php echo $reason; ?></textarea>
			</div>
		...
		<div class=" padding-top20 clearfix">
			<div class="">
				<div class="footer-acnt-save">
					...
					<div class="btn primary-color-bg primary-color-bg bold-font margin-both5 txt-uppercase pull-right">
							<input class="btn-primary-inpt" onclick="return returnorder();" value="<?php echo __d('user','Confirm Return');?>" type="submit">
					</div>
				</div>
			</div>
		</div>
