    ...
    <div class="list-group margin0">
		...
		<?php
			...
			<a href="'.SITE_URL.'mobileapps" class="list-group-item"> '.__d('user','Mobile').'</a>
			<a href="'.SITE_URL.'addto" class="list-group-item"> '.__d('user','Resources').'</a>
			<a href="'.SITE_URL.'help/collections" class="list-group-item"> '.__d('user','Collections').'</a>
			<a href="'.SITE_URL.'help/checkout" class="list-group-item active"> '.__d('user','Checkout').'</a>
			<a href="'.SITE_URL.'help/shippinginfo" class="list-group-item"> '.__d('user','Shipping info').'</a>';
		?>
		</div>
		...
		<div class="acnt-submenu border_bottom_grey">
		<?php
			echo '<a href="'.SITE_URL.'help/aboutus" class="list-group-item">
				'.__d('user','About us').'
			</a>
			<a href="'.SITE_URL.'help/career" class="list-group-item">
				'.__d('user','Career').'
			</a>
			<a href="'.SITE_URL.'help/socialresponse" class="list-group-item">
				'.__d('user','Social responsibility').'
			</a>
			<a href="'.SITE_URL.'help/business" class="list-group-item">
				'.__d('user','Business with us').'
			</a>';
		?>
		</div>
