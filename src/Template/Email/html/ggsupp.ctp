							...
							<tr>
								<td style="padding: 15px 0 45px;"  valign="top">
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
											<?php echo __d('user','There is an order placed on you shop at');?> <?php echo $sitename; ?>
									</p>
									<br>
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
									...
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
										Ship to address:
										<br clear="all" /><br />
											<?php echo __d('user','Name');?>:-  <?php echo $name; ?><br />
											<?php echo __d('user','Address');?>1:-  <?php echo $address1; ?><br />
											<?php echo __d('user','Address');?>2:-  <?php echo $address2; ?><br />
											<?php echo __d('user','City');?>:-  <?php echo $city; ?><br />
											<?php echo __d('user','State');?>:-  <?php echo $state; ?><br />
											<?php echo __d('user','Country');?>:-  <?php echo $countryName; ?><br />
											<?php echo __d('user','Zip Code');?>:-  <?php echo $zipcode; ?><br />
											<?php echo __d('user','Phone No');?>:-  <?php echo $telephone; ?><br />
										<br clear="all" /><br />
									</p>
