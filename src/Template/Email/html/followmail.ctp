					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff" style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> <?php echo $username; ?> <?php echo __d('user','follows you on');?> <?php echo $setngs['site_name']; ?> <?php echo __d('user','now');?>.!</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
			<?php echo $username; ?> <?php echo __d('user','follows you in');?> <?php echo $setngs['site_name']; ?> <?php echo __d('user','now');?>. <?php echo __d('user','You can view his profile by clicking the following link');?>.
