					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff" style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> <?php echo __d('user','You have created group gift on the product in');?> <?php echo $setngs['site_name']; ?> </h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									<p style='margin-bottom: 10px'>
										<?php echo __d('user','Hello');?> <?php echo $creator; ?>,
									</p>
									<p style='margin-bottom: 10px'>
			<?php echo __d('user','You have created a group gift on the product');?>
			<?php
			echo '<a href="'.SITE_URL.'listing/'.$itemurl.'">'.$itemname.'</a>';
			?>

									</p>
									<p style='margin-bottom: 10px'>
<?php echo __d('user','Group Gift Link');?>: <?php echo $giftlink; ?>
									</p>
