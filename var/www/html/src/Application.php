...
class Application extends BaseApplication
{
    ...
    public function middleware($middleware)
    {
        ...
        $socialId = json_decode($setngs['social_id'],true);
        ...
        $middleware
            ...
            'provider' => [
            'facebook' => [
                'applicationId' => $socialId['FB_ID'],
                'applicationSecret' => $socialId['FB_SECRET'],
                'scope' => [
                    'email',
                ],
                'fields' => [
                    'email','first_name','gender','last_name','name'
                    // To get a full list of all posible values, refer to
                    // https://developers.facebook.com/docs/graph-api/reference/user
                ],
            ],
            'google' => [
                'applicationId' => $socialId['GOOGLE_ID'],
                'applicationSecret' => $socialId['GOOGLE_SECRET'],
                'scope' => [
