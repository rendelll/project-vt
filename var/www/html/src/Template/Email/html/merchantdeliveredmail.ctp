					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff" style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "><?php echo __d('merchant','The shipment was successfully delivered to buyer')." - ".__d('merchant','Order ID')." #".$orderid; ?>.</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									<p style='margin-bottom: 10px'>
										<?php echo __d('merchant','Hi'); ?> <?php echo " ".$username; ?>,
									</p>
									<p style='margin-bottom: 10px'>
										<?php echo __d('merchant','This email confirms your shipment on your order')." #".$orderid." ".__d('merchant','was successfully delivered to the buyer').". ".ucwords(strtolower($setngs['site_name'])).__d('merchant','accounts team will review this order and your fund for this order will be delivered within 3 working days'); ?>.

									</p>
									<p style='margin-bottom: 10px'>
										<?php echo __d('merchant','If you do not receive your fund within the time, kindly send an email')." ";?> <a href='<?php echo SITE_URL; ?>help/contact'><?php echo __d('merchant','here'); ?></a>.
