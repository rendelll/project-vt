						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; ">
									<?php echo __d('merchant','There is a dispute in your order ID')." #".$orderid." ".__d('merchant','accepted by')." ".$seller; ?>.
								</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										<?php echo __d('merchant','This email is to notify that there is a dispute raised on your order')." #".$OrderId." ".__d('merchant','It was accepted by')." ".$seller.". ".__d('merchant','We would like you to take this dispute on high priority'); ?>.
									</p>
									<p style='margin-bottom: 10px;'>
										<?php echo __d('merchant','Thanks for your co-operations'); ?>.
									</p>
