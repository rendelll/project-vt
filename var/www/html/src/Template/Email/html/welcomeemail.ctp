					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff" style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> <?php echo __d('user','Hello');?> <?php echo $username; ?>, <?php echo __d('user','Your new account is activated successfully');?>.</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										<?php echo __d('user','Thank you for your email address verification. We have successfully activated your new account with');?> <?php echo $setngs['site_name']; ?>.

									</p>
									<p style='margin-bottom: 10px'>
										<?php echo __d('user','There are plenty of sales is going on and products added everyday to');?> <?php echo $setngs['site_name']; ?>. <?php echo __d('user','You can write to us');?> <a href='<?php echo SITE_URL; ?>help/contact'><?php echo __d('user','here');?></a> <?php echo __d('user','and we are happy to assist you in case of any questions');?>.

									</p>
									<p style='margin-bottom: 10px'>
										<?php echo __d('user','Enjoy shopping on');?> <?php echo $setngs['site_name']; ?> !
