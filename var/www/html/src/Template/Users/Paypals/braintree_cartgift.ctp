<html>
<title><?php echo __d('user','Pay with Card Or Paypal');?></title>
<head>
  <meta charset="utf-8">
    <meta charset="utf-8">
...
<form name="paymentbraintreeform" method="post" action="<?php echo SITE_URL.'braintree/giftcard/'?>">
  <input type="hidden" name="giftamount" value="<?php echo $giftamount; ?>"/>
  <input type="hidden" name="giftcardid" value="<?php echo $giftcardid; ?>"/>
