...
<div class="col-lg-12 p-0">
            <div class="card card-outline-info">
                <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo __d('admin', 'Active Disputes'); ?></h4>
                 </div>
			...
			echo '<thead>';
				...
				if(count($order_data)!=0){
					...
					echo "<tr id='scatgys".$disid."'>";
											...
											echo "<td>";
												if($orders['newstatusup']=="Accepeted")
												{
													echo "Accepted";
												}
												else
										...
										<?php
											...
											if($orders['_matchingData']['Orders']['status']== ''){
												...
												echo $this->Form->input(''.$id.'', array( 'type' => 'select','label' => '' ,'class' =>'resolvestatus'.$id.'','onchange'=> "disputestatus('$id');",'options' => $options,'selected' => 'Pending','style' => 'width:98px ! important;'));
											}else{
