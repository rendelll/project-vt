        ...
        <div class="col-md-12 col-12 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'View Order'); ?></h3>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo $baseurl; ?>	returnedorders"><?php echo __d('admin', 'Returned Orders'); ?></a></li>
...
<?php
	...
	echo '<hr>';
	 ...
	 echo "<span class='pay-to'><b>".__d("admin", "Logistic Details:")."</b></span><br />";
	echo '<span class="pay-status">'.__d('admin', 'Shipment Date:').' '.date('d,M Y',$trackingModel['shippingdate']).'</span><br />';
	echo '<span class="pay-status">'.__d('admin', 'Tracking Id:').' '.$trackingModel['trackingid'].'</span><br />';
	echo '<span class="pay-status">'.__d('admin', 'Logistic Name:').' '.$trackingModel['couriername'].'</span><br />';
	echo '<span class="pay-status">'.__d('admin', 'Shipment Service:').' '.$trackingModel['courierservice'].'</span><br />';
    echo '<span class="pay-status">'.__d('admin', 'Additional Notes:').' '.$trackingModel['notes'].'</span><br />';
	...
	//echo '<tr><td align="left"><p class="gtotal">c</p></td><td style="width:50px;"></td><td align="right"><p class="gtotal"><b>'.$shipping.' '.$orderCurrency.'</b></p></td></tr>';
	...
	echo '
	<tr class="ver_border padding_top10"><td align="left"><p class="gtotal">'.__d('admin', 'Grand Total').'</p></td><td style="width:50px;"></td><td align="right"><p class="gtotal"><b>'.$gtotal.' '.$orderCurrency.'</b></p></td></tr>
