        ...
        <div class="col-md-12 col-12 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'View Order'); ?></h3>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo $baseurl; ?>	refundedorders"><?php echo __d('admin', 'Refunded Orders'); ?></a></li>
...
<?php
	...
	if($discountType!='Giftcard Discount' && $discountType!='User Credits'){
