...
<div class="content">
 	<div class="row page-titles">
        <div class="col-md-12 col-12 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'Cancelled orders'); ?></h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo $baseurl; ?>dashboard"><?php echo __d('admin', 'Home'); ?></a></li>
                     <li class="breadcrumb-item"><a href="#"><?php echo __d('admin', 'Cancelled orders'); ?></a></li>
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo __d('admin', 'Cancelled orders'); ?></h4>
                 </div>
...
<?php
        ...
        echo  '<div class="table-responsive m-t-10">';
          echo '<table id="cancelledorderstable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">';
            echo '<thead>';
							echo '<tr>';
								...
								echo '<th style="cursor:pointer; width: 160px;" data-orderable="false">'.__d('admin', 'View').'</th>';
                                    echo '<th style="cursor:pointer; width: 160px;" data-orderable="false">'.__d('admin', 'Action').'</th>';
							...
							if(count($getitemuser->toArray())!=0)
							{
								foreach($getitemuser as $key=>$user_det){
									...
									echo '<tr id="del_'.$id.'">';
										...
										echo '<td class="invoicePayMthd">'.$order_totalcost[$id].'</td>';
										...
										?>
											...
											<a style="text-decoration:none;" href="<?php echo SITE_URL.'viewcancelledorder/'.$id;?>">
                                        ...
                                        echo '<input type="button" class="btn btn-primary claimedord" style="width: 65px; font-size: 11px;" value="'.__d('admin', 'Refund').'" onclick="refundorderamount('.$id.')"/>';
                                        /*}
                                        else{
                                         echo '<input type="button" class="btn btn-primary claimedord" disabled="disabled" style="width: 65px; font-size: 11px;" value="'.__d('admin', 'Refund').'" onclick="refundorderamount('.$id.')"/>';
                                        }*/
