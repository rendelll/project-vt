            ...
            <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'Products'); ?></h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo $baseurl; ?>dashboard"><?php echo __d('admin', 'Home'); ?></a></li>
                     <li class="breadcrumb-item"><a href="#"><?php echo __d('admin', 'Manage Nonapproved Items'); ?></a></li>
...
<div class="">
            <div class="card card-outline-info">
                <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo __d('admin', 'Manage Nonapproved Items'); ?></h4>
                 </div>
...
<input type="button" id="srchAffiliate" name="submit" value="<?php echo __d('admin', 'Search'); ?>" class="btn btn-info" onclick="return srchnonapproveditems(); " />
<input type="button" id="resetapprov" name="resetapprov" value="<?php echo __d('admin', 'Reset'); ?>" class="btn btn-info"  onclick="return resetnonapproveditems(); " />
</div><div class="col-md-3" style="margin-top:10px;">
...
{
?>
<input type="button" value="<?php echo __d('admin', 'Delete Selected'); ?>" class="btn btn-info" onclick="delete_nonapproveditem()" >
<?php
}
?>
...
echo  '<div class="table-responsive m-t-0">';
					echo '<table id="nonapproveditemstable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">';
						echo '<thead>';
				echo "<tr >";
					...
					echo "<th class='aligncenter' style='max-width: 200px;word-break: break-all;text-overflow: ellipsis;'>".__d("admin", "Item title")."</th>";
          ...
          //echo "<th class='aligncenter'>Mark Featured</th>";
           ...
           // $username = $temp['_matchingData']['Users']['username'];
            //$useremail = $temp['_matchingData']['Users']['email'];
              ...
              echo "<td class='aligncenter'>".$useremail."</td>";
							...
							//echo "<td class='aligncenter'>".$occasion."</td>";
...
echo "<td class='aligncenter' style='max-width: 200px;word-break: break-all;text-overflow: ellipsis;'>";
        for($i=0;$i<$count;$i++)
        {
              ...
              echo "<td class='aligncenter'> <span id='status".$item_id."'>";
                echo "<button class='btnnonappr btn ".$color."' onclick='changeItemStatus(".$item_id.",\"".$temp['status']."\");'>".$buttonLabel."</button>";
...
<script>
    ...
    $('#nonapproveditemstable').DataTable({
    "bInfo" : false,
        dom: 'Bfrtip',
        buttons: [
