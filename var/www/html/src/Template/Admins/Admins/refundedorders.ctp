...
<div class="content">
 	<div class="row page-titles">
        <div class="col-md-12 col-12 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'Refunded orders'); ?></h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo $baseurl; ?>dashboard"><?php echo __d('admin', 'Home'); ?></a></li>
                     <li class="breadcrumb-item"><a href="#"><?php echo __d('admin', 'Refunded orders'); ?></a></li>
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo __d('admin', 'Refunded orders'); ?></h4>
                 </div>
...
<?php
        ...
        echo  '<div class="table-responsive m-t-10">';
          echo '<table id="refundedorderstable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">';
            echo '<thead>';
							echo '<tr>';
								...
								echo '<th style="cursor:pointer;">Order Date</th>';
								...
								foreach($getitemuser as $key=>$user_det){
									...
									echo '<tr id="del_'.$id.'">';
										...
										if(empty($usernames[$user_det['merchant_id']]))
											echo '<td class="invoiceNo">'.__d('admin', 'NA').'</td>';
										else
										...
										?>
											...
											<a style="text-decoration:none;" href="<?php echo SITE_URL.'viewrefundedorder/'.$id;?>">
