            ...
            <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'Products'); ?></h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo $baseurl; ?>dashboard"><?php echo __d('admin', 'Home'); ?></a></li>
                     <li class="breadcrumb-item"><a href="#"><?php echo __d('admin', 'Manage Report Items'); ?></a></li>
...
<div class="col-lg-12 p-0">
            <div class="card card-outline-info">
                <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo __d('admin', 'Manage Report Items'); ?></h4>
                 </div>
...
<input type="button" id="srchAffiliate" name="submit" value="<?php echo __d('admin', 'Search'); ?>" class="btn btn-info"  onclick="return srchReport(); " />
</div> <div class="col-md-3" style="margin-top:10px;">
...
{
?>
<input type="button" value="<?php echo __d('admin', 'Delete Selected'); ?>" class="btn btn-info" onclick="delete_report()" >
<?php
}
?>
...
echo  '<div class="table-responsive m-t-0">';
				...
				echo "<tr>";
					...
					echo "<th class='aligncenter'>".__d("admin", "Report Count")."</th>";
            ...
            $report_count = count($report);
						echo "<tr id='item".$item_id."'>";
							//echo "<td class='aligncenter'>".$this->Form->input('',array('type'=>'checkbox'))."</td>";
              ...
              //echo "<td>".$quantity."</td>";
                    ...
                    echo '<a href="'.SITE_URL.'adminitemview/'.$item_id.'" target="_blank"><input type="button" class="btn btn-rounded btn-outline-success" style="width:auto; font-size: 11px;" value="'.__d('admin', 'View').'"></a>';
                      ...
                      if($demo_active!="yes")
                      echo '<a onclick = "deleteItemAdmin('.$item_id.');" role="button" data-toggle="modal" style="cursor:pointer;"><input type="button" class="btn btn-rounded btn-outline-danger" style="width:auto; font-size: 11px;" value="'.__d('admin', 'Delete').'"></a>';
                      echo '</td>';
						echo "</tr>";
					}
				}else{
