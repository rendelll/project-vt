            ...
            <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('admin', 'Manage Seller'); ?></h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo $baseurl; ?>	dashboard"><?php echo __d('admin', 'Home'); ?></a></li>
                     <li class="breadcrumb-item active"><?php echo __d('admin', 'Approved Seller'); ?></li>
                 </ol>
         </div>
    </div>
</div>
<div class="col-lg-25">
            <div class="card card-outline-info">
                <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo __d('admin', 'Approved Seller'); ?></h4>
                 </div>
    ...
    <?php echo "<div id='userdata'>";
                    ...
                    echo '<table id="approvedsellertable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">';
                        echo '<thead>';
						?>
        ...
        echo '<tr>';
			...
			//echo '<th>'.__d('admin', 'Bank Acc. No.').'</th>';
