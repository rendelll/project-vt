    ...
    <div class="col-12">
        <div class="card">
                <div class="card-block">
                    <h4 class="text-themecolor m-b-0 m-t-0"><?php echo __d('merchant','Category Coupons'); ?></h4>
                    <hr>
                    <div class="col-md-6 col-sm-12 ">

                        <?php echo $this->Form->Create('editcategorycoupon',array('url'=>array('controller' => '/','action' => '/editcategorycoupon/'.$id),'name'=>'editcategorycoupon','id'=>'editcategorycoupon'));
                        ...
                        ?>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <select name="sourceid" class="form-control custom-select">
                                    <?php
                                        foreach($categ_datas as $categ)
                                        {
                                            $categid = $categ['id'];
                                            $categname = $categ['category_name'];

                                            if($sellercoupon['sourceid']==$categid)
                                                echo '<option value="'.$categid.'" selected>'.$categname.'</option>';
                                            else
