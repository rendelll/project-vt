...
<div class="row page-titles m-b-20">
  <div class="col-md-6 col-lg-12 align-self-center">
      <h3 class="text-themecolor m-b-0 m-t-0"><?php echo __d('merchant','Add Category Coupon'); ?></h3>
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo __d('merchant','Add Category Coupon'); ?></li>
      </ol>
  </div>
</div>
    ...
    <div class="col-12">
        <div class="card">
                <div class="card-block">
                    <h4 class="text-themecolor m-b-0 m-t-0"><?php echo __d('merchant','Add Category Coupon'); ?></h4>
                    <hr>
                    <div class="col-md-6 col-sm-12 ">

                        <?php echo $this->Form->Create('addcategorycoupon',array('url'=>array('controller' => '/','action' => '/addcategorycoupon'),'name'=>'addcategorycoupon','id'=>'addcategorycoupon'));
                        ?>
                            <div class="form-group clearfix">
                                <label> <?php echo __d('merchant','Coupon Code'); ?> </label>

                                <input id="couponcodes" name="code" type="text" class="form-control" placeholder="" value=""> 
                            ...
                            <div class="form-group clearfix">
                                <label> <?php echo __d('merchant','Category'); ?> </label>
                                <select id="sourceid" name="sourceid" class="form-control custom-select">
                                    <?php foreach($categ_datas as $categ)
                                    {
                                        $categid = $categ['id'];
                                        $categname = $categ['category_name'];
                            ...
                            <div class="form-group">
                                ...
                                <input id="couponrange" type="text" class="form-control" placeholder="" name="range" value="" maxlength="4"> 
                                <small class="trn form-control-feedback f4-error f4-error-couponrange"></small> 
                            </div>

                            <div class="form-group">
                                <label> <?php echo __d('merchant','Start Date'); ?> </label>
                                <input id="dealstart" name="fromdate" type="text" class="form-control datepicker-autostart" placeholder="MM/DD/YYYY" value="">
                                <small class="trn form-control-feedback f4-error f4-error-dealstart"></small> 
                            </div>

                            <div class="form-group">
                                <label> <?php echo __d('merchant','End Date'); ?> </label>
                                <input id="dealend" name="enddate" type="text" class="form-control datepicker-autoclose" placeholder="MM/DD/YYYY" value="">
                            ...
                            <div class="form-group">
                                ...
                                <input  id='couponamounts' name="amount" maxlength='3' type="text" class="form-control" placeholder="" value="">
